			...
			<div class="jumbotron">
				<div class="container">
					...
					<div class="col-md-9">
						<div class="thumbnail">
							<div class="list-group">
									<h3 align="center">Formularios Para Download </h3>
										<table class="text-center table table-striped table-responsive">
													...
													<tbody>
															<tr>
																<td>Formulario para Solicitação de Tg</td>
																<td><a href="#">Download</a></td>
															</tr>
															<tr>
																<td>Formulario para Realização de Prova</td>
																<td><a href="#">Download</a></td>
															</tr>
															<tr>
																<td>Formulario para Solicitação de Evento</td>
																<td><a href="#">Download</a></td>
															</tr>
												</tbody>
											</table>
