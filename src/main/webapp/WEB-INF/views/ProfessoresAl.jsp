							...
							<nav class="navbar navbar-default navbar-static-top">
								<div class="container">
									<form action=AlteraProfessor method="post">
										<div class="form-group">
											<h2 align="center">Dados de ${prof.nome}</h2>
											<input class="form-control" type="hidden" name="id" value="${prof.id}"/>
										<label for="nome">Nome:</label>
										<input class="form-control" type="text" readonly="true" name="nome" value="${prof.nome}"/>										
										<br />
										<label for="ramal">Ramal:</label>
										<input class="form-control" type="text" readonly="true" name="ramal" value="${prof.ramal}" />
										<label for="sala">Sala:</label>
										<input class="form-control" type="text" readonly="true" name="sala" value="${prof.sala}" />
										<br />
										<label for="email">Email:</label>
										<input class="form-control" type="text" readonly="true" name="email" value="${prof.email}" />
										<br />
									</div>
								</form>
							</div>
